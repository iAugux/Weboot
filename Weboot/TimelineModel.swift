...
class TimelineModel: NSObject {
    ...
    func modelForCell(indexPath: NSIndexPath, cell: WeiboTableViewCell, tableView: UITableView, vc: TimelineViewController) {
        ...
        if statuses != nil{
            ...
            if numberOfImages == 0 {
                ...
                for var i = 0 ; i < numberOfImages ; i++ {
                    ...
                    //                    print("\(statusImageUrl)")
                    cell.images[i].sd_setImageWithURL(statusImageUrl, placeholderImage: UIImage(named: "image_holder"))
                    
                    //                    let statusImageOriginalImageUrl = NSURL(string: statusImage.originalImageUrl)
                    //                    print("\(statusImageOriginalImageUrl)")
                }
            }
            ...
            if let retweetedStatus = status.retweetedStatus{
                ...
                if numberOfRetweetedImages == 0 {
                    ...
                    //                                        print("\(cell.retweetedImageContainer.frame.maxY)")
                    for var i = 0 ; i < numberOfRetweetedImages ; i++ {
                        ...
                        cell.retweetedImages[i].sd_setImageWithURL(retweetedStatusImageUrl, placeholderImage: UIImage(named: "image_holder"))
