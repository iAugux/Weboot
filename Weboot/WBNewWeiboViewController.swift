//
//  WBNewWeiboViewController.swift
//  iAugus
//
...
protocol WBNewWeiboViewControllerDelegate{
    func loadDataAfterPostNewWeibo()
}

class WBNewWeiboViewController: UIViewController{
    var query: WeiboRequestOperation?

    @IBOutlet weak var newWeiboTextField: UITextView!
    
    var delegate: WBNewWeiboViewControllerDelegate!
