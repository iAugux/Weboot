...
/**
    by iAugus
*
*    did some modifications for my project, not original
*/
...
//            view.imageView.backgroundColor = itemBackgroundColor
//            view.imageView.backgroundColor = themeColorArray[index]
    ...
    public func showInViewController(viewController: UIViewController, animated: Bool){
        ...
        for (index, item) in itemViews.enumerate(){
            ...
            item.alpha = 0
//            item.originalBackgroundColor = themeColorArray[index]
